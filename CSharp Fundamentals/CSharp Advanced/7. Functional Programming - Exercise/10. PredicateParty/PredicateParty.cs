namespace PredicateParty
{
    ...
    public class PredicateParty
    {
        ...
        {
            List<string> comming = Console.ReadLine()
        ...
        private static void PrintCommingList(List<string> comming)
        {
            if (comming.Any())
            {
                string names = string.Join(", ", comming);
        ...
        public static void ExecuteCommands(List<string> comming)
        {
        ...
        public static void ForeachName(string command, List<string> comming, Func<string, bool> condition)
        {
