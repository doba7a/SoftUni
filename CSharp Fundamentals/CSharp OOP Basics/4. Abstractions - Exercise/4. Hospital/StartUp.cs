...
public class Program
{
    public static void Main()
    {
        ...
        ReadData(departmentsData, doctorsData);

        PrintOutput(departmentsData, doctorsData);
    }

    private static void ReadData(Dictionary<string, List<string>> departmentsData, Dictionary<string, List<string>> doctorsData)
    {
    ...
    private static void PrintOutput(Dictionary<string, List<string>> departmentsData, Dictionary<string, List<string>> doctorsData)
    {
        string currentInput = Console.ReadLine();
